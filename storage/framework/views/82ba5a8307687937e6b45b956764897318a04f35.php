                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="flex flex-wrap">
                        <label for="email" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            <?php echo e(__('Endereço de E-mail')); ?>:
                        </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center">
                        <label class="inline-flex items-center text-sm text-gray-700" for="remember">
                            ...
                            <span class="ml-2"><?php echo e(__('Lembre-se de Mim')); ?></span>
                        </label>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8">
                            <?php echo e(__("Não possui uma conta ?")); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projetoflexpeak\resources\views/auth/login.blade.php ENDPATH**/ ?>